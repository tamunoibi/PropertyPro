...
class UserController {
  ...
  static async createAccount(req, res) {
    ...
    try {
      ...
      const values = [first_name, last_name, phone_number, hashedpassword, password, email, address, is_admin];
 ...
 */
  ...
  static async getAllUsers(req, res) {
    const sqlQuery = `SELECT id,first_name, last_name, phone_number, email, address is_admin,
                      createdon
